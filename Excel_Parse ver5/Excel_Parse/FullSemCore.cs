...
namespace Excel_Parse
{
    public partial class FullSemCore : Form
    {
        ...
        //обязательно нужно указать, кто вызвал эту форму (может вызваться из KeywordsAreExisted или из главное)
        //в случае KeywordsAreExisted сюда передаются ключи из таблицы на KeywordsAreExisted
