...
namespace Excel_Parse
{
    ...
    {      
        ...
        private void dgv_AdvProducts_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            adGroupName = dgv_AdvProducts1.Rows[e.RowIndex].Cells[3].Value.ToString();
            marketpLaceId = int.Parse(dgv_AdvProducts1.Rows[e.RowIndex].Cells[22].Value.ToString());
            campaignId = int.Parse(dgv_AdvProducts1.Rows[e.RowIndex].Cells[23].Value.ToString());
            productId = int.Parse(dgv_AdvProducts1.Rows[e.RowIndex].Cells[24].Value.ToString());

            ReportAdvertisingFilterView af = new ReportAdvertisingFilterView(this);

            af.ShowDetailedByAdGroup(adGroupName, marketpLaceId, campaignId, productId, advProductsList1);
        }
        ...
        */
        ...
        private void copyToTab3ToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            tb_clbAdGroupFilter3.Text = tb_clbAdGroupFilter1.Text;
            tb_clbAdGroupFilter3.Enabled = tb_clbAdGroupFilter3.Enabled;

            tb_clbTargetingFilter3.Text = tb_clbTargetingFilter1.Text;
            tb_clbTargetingFilter3.Enabled = tb_clbTargetingFilter3.Enabled;
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------------------Отрисовка таблицы с данными НАЧАЛО

        /* Рисуем таблицу dgv_AdvProducts и заполняем её данными (при Custom Mode) */
        ...
        /* Рисуем "правильную" таблицу с заголовками и шириной столбцов для Sponsored Products (при Custom Mode) */
        ...
        /* Рисуем суммирующиую 1ю строку в dgv_AdvProducts (при Custom Mode) */
        ...
        /* Рисуем таблицу dgv_AdvProducts и заполняем её данными (при Products Mode) */
        ...
        /* Непосредственно заполняем таблицу данными (при Products Mode) */
        ...
        /* Рисуем таблицу dgv_AdvProducts и заполняем её данными (при Campaigns Mode) */
        ...
        /* Непосредственно заполняем таблицу данными (при Campaigns Mode) */
        ...
        /* Рисуем таблицу dgv_AdvProducts и заполняем её данными (при AdGroups Mode) */
        ...
        /* Непосредственно заполняем таблицу данными (при AdGroups Mode) */
        ...
        /* Рисуем первый столбец в таблице */
        ...
        /* Рисуем последний столбец в таблице с суммами */
        ...
        /* Получаем имя товара по заданному ASIN */
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------------------Отрисовка таблицы с данными КОНЕЦ
