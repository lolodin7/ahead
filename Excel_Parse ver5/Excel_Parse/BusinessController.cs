...
namespace Excel_Parse
{
    class BusinessController
    {
        ...
        private void SetDataToList(IDataRecord record)
        {
            ...
            {
                businessList[businessList.Count - 1].WriteDataFromDB(i, record[i]);
            }
        }
