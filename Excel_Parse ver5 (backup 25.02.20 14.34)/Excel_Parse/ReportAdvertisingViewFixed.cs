...
namespace Excel_Parse
{
    public partial class ReportAdvertisingViewFixed : Form
    {
        ...
        public void SetTargetingInAdgroupsMode()
        {
            ResetCompareMode();
            targetingInAdgroupsMode = true;
        }
        public void SetAdgroupsInCampaignsMode()
        {
            ResetCompareMode();
            adgroupsInCampaignsMode = true;
        }
        public void SetCampaignInProductsMode()
        {
            ResetCompareMode();
            campaignInProductsMode = true;
        }
        public void SetProductsInMarketplaces()
        {
            ResetCompareMode();
            productsInMarketplaces = true;
        }

        public void SetByCustomDateMode()
        {
            ResetDateModes();
            byCustom = true;
        }

        public void SetByWeeksMode()
        {
            ResetDateModes();
            byWeeks = true;
        }

        public void SetByMonthsMode()
        {
            ResetDateModes();
            byMonths = true;
        }

        public void SetByDaysMode()
        {
            ResetDateModes();
            byDays = true;
        }
        ...
        /* Перерисовываем элементы на форме при изменении размеров формы */
        private void ReportAdvertisingViewFixed_SizeChanged(object sender, EventArgs e)
        {
            ...
            btn_DrawChart.Location = new System.Drawing.Point(this.Width - btn_DrawChart.Size.Width - 40, btn_DrawChart.Location.Y);
        }
    }


    /* Класс для хранения данных, необходимых для прорисовки графика */
    class tmpObj
    {
